...
import (
	scheme "github.com/quobyte/k8s-operator/pkg/kubernetes-actors/clientset/versioned/scheme"
...
type QuobyteClientInterface interface {
	...
	UpdateStatus(*v1.QuobyteClient) (*v1.QuobyteClient, error)
...
func (c *quobyteClients) UpdateStatus(quobyteClient *v1.QuobyteClient) (result *v1.QuobyteClient, err error) {
	result = &v1.QuobyteClient{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("quobyteclients").
