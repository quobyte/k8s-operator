...
func (c *FakeQuobyteClients) List(opts v1.ListOptions) (result *quobyte_com_v1.QuobyteClientList, err error) {
	...
	list := &quobyte_com_v1.QuobyteClientList{ListMeta: obj.(*quobyte_com_v1.QuobyteClientList).ListMeta}
...
func (c *FakeQuobyteClients) UpdateStatus(quobyteClient *quobyte_com_v1.QuobyteClient) (*quobyte_com_v1.QuobyteClient, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(quobyteclientsResource, "status", c.ns, quobyteClient), &quobyte_com_v1.QuobyteClient{})
